...
In this DPR repository, these seven top-level steps and activities are supported by one or more artifact templates: 
...
7. Patterns from twp categories in [Microservice API Patterns (MAP)](https://microservice-api-patterns.org/) are eligible here, the [quality category](https://microservice-api-patterns.org/patterns/quality/) and the [evolution category](https://microservice-api-patterns.org/patterns/evolution/). 
