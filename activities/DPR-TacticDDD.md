...
* Experience with the tool on projects is shared online [here](https://ozimmer.ch/modeling/2022/11/23/ContextMapperInsights.html) and [here](https://blog.mimacom.com/ddd-and-context-mapper-experience/).

The conference can be found on the [Context Mapper website](https://contextmapper.org/background-and-publications/).
